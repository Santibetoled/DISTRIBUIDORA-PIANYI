...
import Zonificacion from "./Zonificacion.jsx";
...
export default function App() {
  ...
  function openModule(mod) {
    ...
    } else if (mod.active && mod.internal) {
      setActiveModule(mod.id);
    }
  }

  /* ── Internal Module Views ── */
  if (user && activeModule === "zonificacion") {
    return <Zonificacion user={user} onBack={function () { setActiveModule(null); }} />;
  }
